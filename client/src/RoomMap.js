...
class RoomMap extends React.Component {
  ...
  isdisabled(value) {
    return this.state.roomsAvailableNr.includes(value) ? "" : "disabled";
  }
      ...
      return (
        <div className=" room-box col-lg-5">
          ...
          <div className="room-info">
            ...
            <br />
            Cena niska:{" " + room.priceLow}
            <br />
            Cena średnia:{" " + room.priceMedium}
            <br />
            Cena wysoka:{" " + room.priceHigh}
            <br />
        ...
        <div id="svg-map" className="col-lg-5 mr-3">
          ...
          >
            ...
            <g
              id="room1"
              className={
                this.isdisabled(1) + " room-hover " + this.isSelected(1)
              }
              onClick={() => {
                this.handleClickSVG(1);
              }}
            >
              <rect
                id="room1-rect"
            ...
            <g
              id="room2"
              className={
                this.isdisabled(2) + " room-hover " + this.isSelected(2)
              }
              onClick={() => {
                this.handleClickSVG(2);
              }}
            >
              <rect
                id="room2-rect"
            ...
            <g
              id="room3"
              className={
                this.isdisabled(3) + " room-hover " + this.isSelected(3)
              }
              onClick={() => {
                this.handleClickSVG(3);
              }}
            >
              <rect
                id="room3-rect"
            ...
            <g
              id="room4"
              className={
                this.isdisabled(4) + " room-hover " + this.isSelected(4)
              }
              onClick={() => {
                this.handleClickSVG(4);
              }}
            >
              <g id="room4-rect">
                <polyline
            ...
            <g
              id="room5"
              className={
                this.isdisabled(5) + " room-hover " + this.isSelected(5)
              }
              onClick={() => {
                this.handleClickSVG(5);
              }}
            >
              <g id="room5-rect">
                <polyline
